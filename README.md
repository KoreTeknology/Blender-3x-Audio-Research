...
- Audaspace Library [1.3.0 Official documentation](https://audaspace.github.io/), and its repository by neXyon: [High level audio library written in C++](https://github.com/neXyon/audaspace)
